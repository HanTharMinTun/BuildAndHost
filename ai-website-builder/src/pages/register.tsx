          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white/5 text-purple-200/40 font-serif-light">or continue with</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white hover:bg-gray-50 text-gray-700 font-body font-medium rounded-2xl transition-all duration-300 border border-gray-200 hover:border-gray-300 hover:scale-[1.02] group relative overflow-hidden"
            >
