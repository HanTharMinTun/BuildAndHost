                                    ...
                                    <div className="flex flex-col gap-2">
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                ...
                                                className="flex-1 px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium rounded-lg hover:shadow-lg hover:scale-105 transition-all flex items-center justify-center gap-2"
                                            >
                                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <button
                                            ...
                                            className="w-full px-4 py-2 bg-red-500/20 text-red-300 font-medium rounded-lg hover:bg-red-500/30 transition-all flex items-center justify-center gap-2"
